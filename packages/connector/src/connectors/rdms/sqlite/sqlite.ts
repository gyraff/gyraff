...
import {SQLiteStorageConnectorFactoryType} from "./contract";

export const SQLiteStorageConnector: SQLiteStorageConnectorFactoryType = RDMSStorageConnector.compose<{}>({
